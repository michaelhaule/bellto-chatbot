...
function getBotResponse(text) {
    botResponse = `<img class="botAvatar" src="./static/img/maya_avatar.png"/><span class="botMsg">${text}</span><div class="clearfix"></div>`;
    return botResponse;
}
...
function setBotResponse(response) {
    ...
    setTimeout(() => {
        ...
        if (response.length < 1) {
            ...
            const BotResponse = `<img class="botAvatar" src="./static/img/maya_avatar.png"/><p class="botMsg">${fallbackMsg}</p><div class="clearfix"></div>`;
                ...
                if (Object.hasOwnProperty.call(response[i], "text")) {
                    if (response[i].text != null) {
                        ...
                        if (html.includes("<ul") || html.includes("<ol") || html.includes("<li") || html.includes('<h3')) {
                            ...
                            if (!botResponse) {
                                botResponse = `<img class="botAvatar" src="./static/img/maya_avatar.png"/><p class="botMsg">${response[i].text}</p><div class="clearfix"></div>`;
                            }
                        }
...
function send(message) {
    ...
    $.ajax({
        ...
        data: JSON.stringify({ Body: message, From: sender_id }),
